...
#alternative data preparation where sampling data included in subsequent analyses is all cut off at the same (early) point 
...
### CUT OFF ALL SAMPLING AT 2019 SAMPLE END DATE ###
...
#run subsequent hypervolume and interaction network generation scripts using this prepared data instead of "1 - Data prepatation.R"
#investigate how sample sizes and hypervolumes/model outputs change
