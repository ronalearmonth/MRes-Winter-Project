...
#apply selectinteractiondata function to list
...
#apply make_matrix function to Q and W lists
...
bootstrappedH2<-function(web1,web2,web3,web4){
  H2bootstrap=list(mat1=web1,mat2=web2,mat3=web3,mat4=web4)%>%
    ...
    boot_networklevel(col_lower = "lower", # column name for bees
                      col_higher = "higher", # column name for plants
                      level = "both", #calculate based on plants and bees
                      index = "H2", #network metric
                      start = 20,
                      step = 10,
...
#bootstrap H2 for queen networks
...
H2qp<-queenH2_plot$H2 + theme_classic() + 
...
H2wp<-workerH2_plot$H2 + theme_classic() + 
  xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
  ylab("H2") +theme(legend.title=element_blank())+ggtitle("Workers")

H2p<-ggarrange(H2qp,H2wp,common.legend=T)

#stats on H2 for each caste between years
...
bootstrappedconnectance<-function(web1,web2,web3,web4){
  connectancebootstrap=list(mat1=web1,mat2=web2,mat3=web3,mat4=web4)%>%
    ...
    boot_networklevel(col_lower = "lower", # column name for bees
                      col_higher = "higher", # column name for plants
                      level = "both",
                      index = "connectance", #network metric
                      start = 20,
                      step = 10,
                      n_boot = 1000,  # number of bootstraps
                      n_cpu = 4)
...
#bootstrap connectance for queen networks
...
conqp<-queenconnectance_plot$connectance + theme_classic() + 
  xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
  ylab("Connectance") +theme(legend.title=element_blank())+ggtitle("Queens")

#bootstrap connectance for worker networks
...
conwp<-workerconnectance_plot$connectance + theme_classic() + 
  xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
  ylab("Connectance") +theme(legend.title=element_blank())+ggtitle("Workers")

conplots<-ggarrange(conqp,conwp)

#stats on connectance for each caste between years
...
bootstrappedevenness<-function(web1,web2,web3,web4){
  evennessbootstrap=list(mat1=web1,mat2=web2,mat3=web3,mat4=web4)%>%
    ...
    boot_networklevel(col_lower = "lower", # column name for bees
                      col_higher = "higher", # column name for plants
                      level = "both",
                      index = "interaction evenness", #network metric
                      start = 20,
                      step = 10,
                      n_boot = 1000,  # number of bootstraps
                      n_cpu = 4)
...
evenwp<-workerevenness_plot$evenness + theme_classic() + 
  xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
  ylab("Evenness") +theme(legend.title=element_blank())+ggtitle("Workers")

#plot both funnel plots
evenplots<-ggarrange(evenqp,evenwp)

#stats on evenness for each caste between years
...
#use Tukey tests to get comparisons
...
#plot evenness by development temperature year
...
#bootstrap nestedness for queen networks
...
nodfqp<-queennestedness_plot$NODF + theme_classic() + 
 xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
...
nodfwp<-workernestedness_plot$NODF + theme_classic() + 
 xlab("Sample size") + scale_color_discrete(c("#CC6677", "#88CCEE","#DDCC77", "#117733"),labels=c('2018', '2019','2021','2022'))+
  ylab("NODF") +theme(legend.title=element_blank())+ggtitle("Workers")

nodfplots<-ggarrange(nodfqp,nodfwp)

#stats on NODF for each caste between years
...
#plot nestedness by development temperature year
...
## ALL RAREFACTION PLOTS FOR APPENDIX ##

ggarrange(H2qp,H2wp,conqp,conwp,evenqp,evenwp,nodfqp,nodfwp,
          nrow=4,ncol=2)
